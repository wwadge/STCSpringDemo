...
public class DataLayerSchedulerImpl implements DataLayerScheduler {
	/** Singleton reference to this class. */
	private static DataLayerScheduler instance;
	/** map lock. */
 ...
 /** Sessionfactory in use. Filled in by Spring. */ 
	...
	public void setApplicationContext(ApplicationContext ctxt) {
		DataLayerSchedulerImpl.context = ctxt;
	}
	...
	* @return GenericDAO<T, ?> object
		...
		synchronized (daoMapLock) {
    		if (daoMap == null) {
    			daoMap = new ConcurrentHashMap<Class<?>, GenericDAO<?, ?>>(); 
	 	   		daoMap.put(DemoTest.class, HibernateSchedulerDaoFactory.getDemoTestDao());
    		}
		 }
     ...
     * Will load the object internally so consider using delete (DemoTest obj) directly
     * @param id Identifier to delete
     */
    public void deleteDemoTest(final Integer id)  {
        HibernateSchedulerDaoFactory.getDemoTestDao().delete(loadDemoTest(id));
    }
	
    /**
     * Loads the given Object.
     * @param id Identifier to load
     * @return a DemoTest object
     */
    public DemoTest loadDemoTest(final Integer id) {
        return HibernateSchedulerDaoFactory.getDemoTestDao().load(id);
    }
    /**
     * Loads the given Object.
     * @param id Id to load
     ...
     */
     public DemoTest getDemoTest(final Integer id) {
        return HibernateSchedulerDaoFactory.getDemoTestDao().get(id);
    }  
    /** Returns a singleton instance of this class.
     * @return an singleton instance
     */
    public static synchronized DataLayerScheduler getInstance() {
        
        if (instance == null) {
        	if (context == null) {
        		throw new IllegalStateException("Context is null. Make sure Spring is initialized.");
        	}
     		instance = (DataLayerScheduler) context.getBean("dataLayerSchedulerImpl");
        }
