...
google.load("jquery", "1.7.1");
  ...
  <body>
   ...
   <form:form id="reset-form" modelAttribute="passwordChangeForm" action="${formUrl}" method="POST">
   <form:errors path="*" > </form:errors>
			<fieldset>
				<div class="control-group" id="newPasswordControlGroup">
				...
				<div class="control-group" id="confirmPasswordControlGroup">
